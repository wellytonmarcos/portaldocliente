...
class LoginView0 extends StatefulWidget {
  LoginView0({this.email});

  final String email;

  _LoginView0State createState() => _LoginView0State();
}

class _LoginView0State extends State<LoginView0> {
